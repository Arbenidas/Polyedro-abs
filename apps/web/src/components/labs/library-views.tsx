  ...
  return (
    <div>
      ...
      >
        <div>
          <div style={viewHeading}>Brand Kit</div>
          <div style={viewSub}>Generated by Brand Agent · status: {regenerating ? "generating" : brandKit.status}</div>
          {error && <div style={{ ...viewSub, color: CORAL, marginTop: 2 }}>{error}</div>}
        </div>
        <button
  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={viewSub}>
          {AGENT_DEFS.length} specialized collaborators. You approve; they execute.
          {dashboard ? ` · ${dashboard.campaign.name}` : " · no active campaign"}
        </div>
      </div>
